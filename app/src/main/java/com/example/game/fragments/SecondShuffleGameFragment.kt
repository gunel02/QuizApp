...
import com.example.game.databinding.FragmentSecondShuffleGameBinding
import java.math.RoundingMode
import kotlin.random.Random


class SecondShuffleGameFragment : Fragment() {

    private lateinit var binding: FragmentSecondShuffleGameBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSecondShuffleGameBinding.inflate(inflater, container, false)
    ...
    private fun getRandomNumber(): Double {
        val rawPositive = Random.nextDouble(0.1, 10.0)
